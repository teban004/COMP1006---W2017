            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <?php
                    ...
                    foreach ($games as $game) {
                        ...
                        echo '<td><button class="btn btn-primary"><i class="fa-thin fa-pen-to-square"></i>Edit</button></td>';
                        echo '<td><button class="btn btn-danger"><i class="fa-thin fa-trash-can"></i>Delete</button></td>';
                        echo "</tr>";
                    }
